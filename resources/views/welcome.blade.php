...
@section('content')
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">Bienvenue à Live Straming</div>
            <div class="masthead-heading text-uppercase">Solution de streaming vidéo d'entreprise</div>
            <a class="btn btn-danger btn-xl text-uppercase" href="{{ url('streaming') }}">
                <i class="fa fa-video"></i> DEMO EN DIRECT
            </a>
        </div>
    </header>
    <!-- Services-->
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Délivre les solutions de transmission et de distribution en direct de la plus haute qualité.</h3>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="my-3">Diffusion en direct</h4>
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Markiting digital</h2>
    ...
    <section class="page-section" id="about">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Graphisme</h2>
                <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
            </div>
            <ul class="timeline">
                <li>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Contactez-nous pour </h3>
            </div>
            <!-- * * * * * * * * * * * * * * *-->
